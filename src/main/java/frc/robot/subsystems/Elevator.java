    ...
    setDefaultCommand(new Command() {
      ...
      protected void execute() {
        ...
        if(OI.getPrimaryA()){
          ...
          RobotMap.elevatorBot.configNominalOutputForward(0, 10);
          RobotMap.elevatorBot.configNominalOutputReverse(0, 10);
          RobotMap.elevatorBot.configPeakOutputForward(1, 10);
          RobotMap.elevatorBot.configPeakOutputReverse(-1, 10);
        ...
        if (elevatorState != ElevatorState.MANUAL) {
          ...
          // RobotMap.elevatorBot.configMotionCruiseVelocity(100, 10);
          // RobotMap.elevatorBot.configMotionAcceleration(10, 10);
          RobotMap.elevatorBot.set(ControlMode.Position, 100);
