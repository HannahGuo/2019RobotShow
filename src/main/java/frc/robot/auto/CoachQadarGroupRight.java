...
public class CoachQadarGroupRight extends CommandGroup {
  public CoachQadarGroupRight() {
    ...
    addSequential(new TurnToAngle(-59, 1.0));
    addSequential(new DriveStraight(-11000));
    addSequential(new DriveStraight(0, ElevatorState.HATCH2));
    addSequential(new LimeLightFwoosh());
    addSequential(new DriveStraight(0, ElevatorState.HATCH2, true));
